...
public class FrmSalidaAlimentos extends JInternalFrame implements ActionListener {
	...
	private JLabel lblDonativosDeTipo;
	private JLabel lblSregistrarLaSalida;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrmSalidaAlimentos frame = new FrmSalidaAlimentos();
	 ...
	 * Create the frame.
	 */
	public FrmSalidaAlimentos() {
		setTitle("Consumo || Salida de Alimentos");
		...
		lblSalidaDeAlimentos = new JLabel("Salida de Alimentos");
		lblSalidaDeAlimentos.setFont(new Font("Tahoma", Font.BOLD, 21));
		lblSalidaDeAlimentos.setBounds(275, 12, 237, 36);
		...
		lblDonativosDeTipo = new JLabel("de tipo alimentos para consumo local.");
		lblDonativosDeTipo.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblDonativosDeTipo.setBounds(18, 41, 308, 25);
		contentPane.add(lblDonativosDeTipo);
		
		lblSregistrarLaSalida = new JLabel("Solo para registrar la salida de donativos ");
		lblSregistrarLaSalida.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblSregistrarLaSalida.setBounds(18, 11, 247, 42);
		contentPane.add(lblSregistrarLaSalida);
	}
