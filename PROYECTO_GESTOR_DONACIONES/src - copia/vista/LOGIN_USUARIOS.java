...
public class LOGIN_USUARIOS extends JFrame implements ActionListener {
	int contador;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LOGIN_USUARIOS frame = new LOGIN_USUARIOS();
	...
	//valida al usuario si la contraseña es correcta
		void validarUsuario_Contraseña(){
			...
			if (posicion==0 && pass.equals(contraseña)){
				...
				switch(contador){
				case 0:JOptionPane.showMessageDialog(LOGIN_USUARIOS.this,
						"Usuario o contraseña incorrecto." + "\nLe queda 4 intentos, intente de nuevo.", "Error",
						JOptionPane.ERROR_MESSAGE);
				password.setText("");
				break;
				
				case 1:JOptionPane.showMessageDialog(LOGIN_USUARIOS.this,
						"Usuario o contraseña incorrecto." + "\nLe queda 3 intentos, intente de nuevo.", "Error",
						JOptionPane.ERROR_MESSAGE);
				password.setText("");
				break;
				
				case 2:JOptionPane.showMessageDialog(LOGIN_USUARIOS.this,
						"Usuario o contraseña incorrecto." + "\nLe queda 2 intentos, intente de nuevo.", "Error",
						JOptionPane.ERROR_MESSAGE);
				password.setText("");
				break;
				
				case 3:JOptionPane.showMessageDialog(LOGIN_USUARIOS.this,
				...
				default:
					JOptionPane.showMessageDialog(LOGIN_USUARIOS.this,
