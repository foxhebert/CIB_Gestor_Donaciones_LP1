...
public class FrmRegistroUsuario extends JFrame implements ActionListener {
	...
	public void CargarTabla(){
		//DE ESTE EJERCCIO FALTO PONER EL ENCABEZADO AL LISTADO
		//para los listados El Jtable debe ir dentro de un JScrollPane
	...
	public FrmRegistroUsuario() {
		...
		lblFechaIngreso.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblFechaIngreso.setBounds(358, 75, 167, 24);
		contentPane.add(lblFechaIngreso);
		
		txtDNI = new JTextField();
		txtDNI.setFont(new Font("Tahoma", Font.PLAIN, 15));
		txtDNI.setBounds(160, 79, 155, 26);
		...
		txtApellido.setBounds(160, 136, 155, 26);
		contentPane.add(txtApellido);
		
		txtNombre = new JTextField();
		txtNombre.setFont(new Font("Tahoma", Font.PLAIN, 15));
		txtNombre.setColumns(10);
		txtNombre.setBounds(160, 109, 155, 26);
		contentPane.add(txtNombre);
		
		txtCargo = new JTextField();
		txtCargo.setFont(new Font("Tahoma", Font.PLAIN, 15));
		txtCargo.setColumns(10);
		txtCargo.setBounds(160, 164, 155, 26);
	    ...
	    /**************************************************************************/
				...
				btnEliminar.setBounds(562, 157, 176, 41);
				contentPane.add(btnEliminar);
				
				btnCerrar = new JButton("Cerrar");
				btnCerrar.addActionListener(this);
				btnCerrar.setFont(new Font("Tahoma", Font.BOLD, 14));
				btnCerrar.setBounds(562, 27, 176, 41);
				...
				btnActualizar.setBounds(562, 113, 176, 41);
