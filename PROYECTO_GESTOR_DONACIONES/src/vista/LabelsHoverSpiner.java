...
public class LabelsHoverSpiner extends JLabel{

	
	private float opacidad = 0.05f;  //Default
	
	public LabelsHoverSpiner ()
	{
		super();
		addMouseListener(new EventLabels());
	}
	
	public LabelsHoverSpiner (String texto)
	{
		super(texto) ;
		addMouseListener(new EventLabels());
	}
	...
	public void mouseEntered(MouseEvent e) {
		...
		efectHover(0f, 0.06f, 0.05f, 1,false);
	}
/**/
	@Override
