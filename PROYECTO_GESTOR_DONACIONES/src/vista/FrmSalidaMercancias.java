...
public class FrmSalidaMercancias extends JInternalFrame implements ActionListener {
	...
	public FrmSalidaMercancias() {
		setTitle("Consumo || Consumo de  Productos");
		...
		lblSalidaDeAlimentos = new JLabel("Salida y Consumo de Productos");
		lblSalidaDeAlimentos.setFont(new Font("Tahoma", Font.BOLD, 21));
		lblSalidaDeAlimentos.setBounds(209, 11, 367, 36);
		...
		lblRegistrarLaSalida.setBounds(18, 58, 247, 25);
		...
		lblRegistrarLaSalida_1.setBounds(18, 37, 220, 42);
